...
describe('AdvertisementController', () => {
  ...
  describe('getAdvertisements', () => {
    it('should return all advertisements', async () => {
      const result: Advertisement[] = [
        { userId: '1', title: 'title', description: 'description', price: 1, typeOfProperty: 'room' },
        { userId: '2', title: 'title2', description: 'description2', price: 2, typeOfProperty: 'apartment' },
      ]
  ...
  describe('postAdvertisement', () => {
    it('should create a new advertisement', async () => {
      const result: Advertisement = { userId: '1', title: 'title', description: 'description', price: 1, typeOfProperty: 'room' }
